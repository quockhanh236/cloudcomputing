...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    ...
    <div class="w3-right w3-hide-small">
      <a href="home.html" class="w3-bar-item w3-button" color="w3-white">Home</a>
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  <img class="w3-image" src="image/background.jpg" alt="Architecture" width="1500" height="800" size="cover">
  <div class="w3-display-middle w3-margin-top w3-center">
		  ...
		  <div class="w3-container w3-padding-32" id="#">
		    ...
		    <p style="color:white;">Insert information</p>
